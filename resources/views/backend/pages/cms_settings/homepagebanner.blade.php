    ...
    <div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary"><a href="/" class="text-decoration-none">Home Banner Settings</a> </h6>
                            ...
                            {{-- @dd($shopBanner) --}}
                                @foreach ($shopBanner as $bannerItem)
                                    <tr data-banner="{{ json_encode($bannerItem)}}">
                                        ...
                                        <td>
                                            @if($bannerItem->mobile_banner_image)
                                                <img src="{{ asset($bannerItem->mobile_banner_image) }}" style="width: 100px;" alt="Mobile Banner Image">
                                            @else 
                                                <img src="" style="width: 150px;" alt="Banner Image">
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('admin.homepagebanner.destroy', $bannerItem->id )}}" class="fa fa-trash text-danger text-decoration-none delete"></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endisset
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold modal-heading" id="exampleModalLabel"> <span class="heading">Create</span> Home Banner</h5>
                    ...
                    <div id="service-container">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                {!! renderFileInput(['id' => 'mobileBannerImage', 'previewId' => 'mobileImage']) !!}
                                <span class="v-msg"></span>
                            </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('change', '#mobileBannerImage', checkMobileImage)
        ...
        ajaxFormToken();
            ...
            let obj = {
                url     : `{{ route('admin.homepagebanner.update', '' ) }}/${id}`, 
                method  : "PUT",
                data    : formatData(),
            };
        ...
        function submitToDatabase(){
            ...
            ajaxFormToken();
                ...
                let obj = {
                    url     : `{{ route('admin.homepagebanner.store')}}`, 
                    method  : "POST",
                    data    : formatData(),
                };
        ...
        function formatData(){
            return {
                ...
                mobile_banner_image : fileToUpload('#mobileImage'),
