    ...
    <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8">
        <thead>
            <tr>
                ...
                <td width="15%">Supplier Email</td>
                <td width="10%">Supplier NO</td>
            ...
            {{-- @dd($getsuppliers) --}}
                ...
                @foreach ($getsuppliers as $item)
                    <tr style="border-bottom: 1px solid #000;">
                        ...
                        <td align="center">{{  $item->supplier_name ?? 'N/A' }}</td>
                        <td align="center">{{  $item->supplier_email ?? 'N/A' }}</td>
                        <td align="center">{{  $item->supplier_phone ?? 'N/A' }}</td>
                        <td align="center">{{  $item->supplier_address ?? 'N/A' }}</td>
