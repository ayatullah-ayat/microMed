...
<body>
    <htmlpageheader name="myheader">
        <div class="row">
            <div class="col-6">
                <img width="200px" height="50px" src="https://micromediabd.com/public/assets/frontend/img/invoice_mic_logo-01.png" alt="Micromedia_Logo">
            </div>
            <div class="col-6">
                <div class="row">
                    <div class="col-6">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="row">
                    ...
                    <img height="48px" src="data:image/png;base64,{{ DNS1D::getBarcodePNG('23543545656', 'I25+') }}" alt="barcode">
                    </div>
                </div>
