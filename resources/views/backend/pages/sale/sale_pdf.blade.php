    ...
    <table class="items" width="100%" style="font-size: 9pt; border-collapse: collapse; " cellpadding="8">
        <thead>
            <tr> 
                ...
                <td align="right" width="10%">Total Qty</td>
                <td align="right" width="10%">Total Amount</td>
                <td align="right" width="10%">Total Payment</td>
                <td align="right" width="10%">Total Due</td>
            </tr>
        </thead>
        <tbody>
            @isset($getsales)
            ...
            @endphp
                ...
                @php
                    ...
                    $total_due      += $item->total_payment_due;
                @endphp
                    <tr style="border-bottom: 1px solid #000;">
                        ...
                        <td align="right">{{  $item->sold_total_qty ?? 'N/A' }}</td>
                        <td align="right ">{{  $item->order_grand_total ?? 'N/A' }}</td>
                        <td align="right ">{{  $item->total_payment ?? 'N/A' }}</td>
                        <td align="right ">{{  $item->total_payment_due ?? 'N/A' }}</td>
                    </tr>
                @endforeach
            @endisset
            <!-- END ITEMS HERE -->
