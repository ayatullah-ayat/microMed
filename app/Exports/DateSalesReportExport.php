...
class DateSalesReportExport implements FromCollection, WithHeadings, WithMapping,WithStyles,WithEvents
{
    /**
    ...
    */
    ...
    {
        foreach($rows as $row){
            $this->summaryRow[3]+= $row->sold_total_qty;
            $this->summaryRow[4]+= $row->order_grand_total;
        }
